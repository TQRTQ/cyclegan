...
def main(epoch,n_epochs,data_split,dataset_name,batch_size,lr,b1,b2,decay_epoch,patience,img_height,img_width,channels,sample_interval
    ...
    G_AB = Generator_hess_constrain()
    G_BA = Generator_hess_constrain()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_name", type=str, default="mpi_necp_hess_1950_2014_constrain_p20_3", help="name of the dataset")
